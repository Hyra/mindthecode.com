...
@section('content')
    ...
    <div class="mx-auto max-w-2xl mt-20">
        <div class="prose prose-xl">
            ...
            <p>I try to note down everything I come across while developing or being part of the development process which I
                think might be useful to others. If it helps one other person I'm happy.</p>
        </div>
            ...
            @foreach ($articles as $article)
                <div>
                    ...
                    <small class="text-blue-200 text-sm">
                        {{ \Carbon\Carbon::parse($article->published_at)->format('F jS, Y') }} •
                    ...
                    <div class="flex flex-col items-end">
                        <div>
                            <a href="{{ Route('articles.show', $article->slug) }}"
                                class="text-white text-lg hover:text-red-400">Continue reading</a>
                        </div>
                    </div>
                </div>
            @endforeach
